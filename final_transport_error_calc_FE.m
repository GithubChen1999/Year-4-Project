...
xlabel("log(dt)")
ylabel("log(error)")
title("FE with "+method+" viscosity "+"  Error=1-norm" ," Gradient is "+ p(1))
...
xlabel("log(dt)")
ylabel("log(error)")
title("FE with "+method+" viscosity "+"  Error=2-norm" ," Gradient is "+ p(1))
