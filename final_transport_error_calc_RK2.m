...
%     legend("RK2","Real")
%     title("RK2 with Smooth function with h="+h+"  \Delta t=" +dt)
...
xlabel("log(dt)")
ylabel("log(error)")
title("RK2 with "+method+" viscosity "+"  Error=1-norm" ," Gradient is "+ p(1))
...
xlabel("log(dt)")
ylabel("log(error)")
title("RK2 with "+method+" viscosity "+"  Error=2-norm" ," Gradient is "+ p(1))
